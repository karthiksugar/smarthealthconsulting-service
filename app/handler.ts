...
import { ConsultingController } from './controller/consulting';

const consultingController = new ConsultingController();

export const testapi: Handler = () => consultingController.testapi();


export const login: Handler = (event: any, context: Context) => {
  return consultingController.login(event, context);
}
